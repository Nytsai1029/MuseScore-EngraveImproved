...
FocusableItem {
    ...
    Column {
        ...
        FlatRadioButtonGroupPropertyView {
            ...
            model: [
                { text: qsTrc("inspector", "Auto"), value: NoteHead.DOT_POSITION_AUTO, title: qsTrc("inspector", "Auto", "augmentation dot position") },
                { iconCode: IconCode.DOT_BELOW_LINE, value: NoteHead.DOT_POSITION_DOWN, title: qsTrc("inspector", "Down", "augmentation dot position") },
                { iconCode: IconCode.DOT_ABOVE_LINE, value: NoteHead.DOT_POSITION_UP, title: qsTrc("inspector", "Up", "augmentation dot position") }
            ]
        }
        ...
        ExpandableBlank {
            ...
            contentItemComponent: Column {
                ...
                SpinBoxPropertyView {
                    id: ledgerLineLengthOffsetLeftView

                    titleText: qsTrc("inspector", "Ledger line length offset (left)")
                ...
                SpinBoxPropertyView {
                    id: ledgerLineLengthOffsetRightView

                    titleText: qsTrc("inspector", "Ledger line length offset (right)")
                    ...
                    navigationPanel: root.navigationPanel
                    navigationRowStart: ledgerLineLengthOffsetLeftView.navigationRowEnd + 1
                }
                ...
                FlatRadioButtonGroupPropertyView {
                    ...
                    navigationPanel: root.navigationPanel
                    navigationRowStart: ledgerLineLengthOffsetRightView.navigationRowEnd + 1

...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::LEDGER_LINE_LENGTH_OFFSET_LEFT,      P_TYPE::SPATIUM,                   PropertyGroup::APPEARANCE, false, "ledgerLineLengthOffsetLeft",       QT_TRANSLATE_NOOP("engraving/propertyName", "ledger line length offset left") },
    { Pid::LEDGER_LINE_LENGTH_OFFSET_RIGHT,     P_TYPE::SPATIUM,                   PropertyGroup::APPEARANCE, false, "ledgerLineLengthOffsetRight",      QT_TRANSLATE_NOOP("engraving/propertyName", "ledger line length offset right") },

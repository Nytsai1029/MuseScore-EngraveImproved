...
enum class Pid {
    ...
    DEAD,
    PLAY,
    LEDGER_LINE_LENGTH_OFFSET_LEFT,
    LEDGER_LINE_LENGTH_OFFSET_RIGHT,
    TIMESIG_NOMINAL,
    ...
    OTTAVA_TYPE,
    NUMBERS_ONLY,
    OTTAVA_ALLOW_BROKEN_LINE,
    OTTAVA_BREAK_POINTS_COUNT,
    OTTAVA_BREAK_POINT_1_OFFSET,
    OTTAVA_BREAK_POINT_2_OFFSET,
    OTTAVA_BREAK_POINT_3_OFFSET,
    OTTAVA_BREAK_POINT_4_OFFSET,
    TRILL_TYPE,
    VIBRATO_TYPE,
    HAIRPIN_CIRCLEDTIP,
    ...
    SLUR_MULTI_BEZIER_ENABLED,
    SLUR_MULTI_BEZIER_KNOT_COUNT,
    SLUR_CURVE_MODE,
    SLUR_MULTI_BEZIER_DATA,
    ...
    SYMBOLS_SIZE,
    SYMBOL_ANGLE,
    SYMBOL_SHORT_SIDE_LENGTH,
    SYMBOL_LONG_SIDE_LENGTH,
    SYMBOL_TOP_HOOK_LENGTH,
    SYMBOL_BOTTOM_HOOK_LENGTH,

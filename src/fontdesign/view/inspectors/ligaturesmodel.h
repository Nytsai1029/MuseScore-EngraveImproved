...
class LigaturesModel : public QAbstractListModel, public muse::Injectable, public muse::async::Asyncable
{
    Q_OBJECT
...
public:
    explicit LigaturesModel(QObject* parent = nullptr);
    ...
    Q_INVOKABLE void addLigature(const QString& name);
    ...
    Q_INVOKABLE void setComponents(int row, const QString& csv);
...
private:
    ...
    static QString componentsToCsv(const std::vector<std::string>& components);
    static std::vector<std::string> csvToComponents(const QString& csv);

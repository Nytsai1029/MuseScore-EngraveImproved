...
MUSESCORE_BUILD_CRASHPAD_CLIENT=${MUSESCORE_BUILD_CRASHPAD_CLIENT:-"OFF"}
...
# Network features are disabled by default in this fork (set env vars to ON to re-enable)
MUSESCORE_MODULE_UPDATE=${MUSESCORE_MODULE_UPDATE:-"OFF"}
MUSESCORE_MODULE_CLOUD=${MUSESCORE_MODULE_CLOUD:-"OFF"}
MUSESCORE_MODULE_LEARN=${MUSESCORE_MODULE_LEARN:-"OFF"}
MUSESCORE_BUILD_MUSESOUNDS_MODULE=${MUSESCORE_BUILD_MUSESOUNDS_MODULE:-"OFF"}
...
function do_build() {
    ...
    cmake .. -GNinja \
        ...
        -DMUSE_MODULE_CLOUD="${MUSESCORE_MODULE_CLOUD}" \
        -DMUSE_MODULE_LEARN="${MUSESCORE_MODULE_LEARN}" \
        -DMUE_BUILD_MUSESOUNDS_MODULE="${MUSESCORE_BUILD_MUSESOUNDS_MODULE}" \
